...
if(isset($_POST['btnregister']))
{
	if(isset($_POST['checkuser']))
	{
		...
		$q=mysqli_query($con,"insert into admin_master values(null,'$name','$encrypt_pass','$email','$mobile','$file_name')");
...
if(isset($_POST['btnlog']))
{
	...
	$a=mysqli_query($con,"select * from admin_master where email='$email' and password='$decode_pass' ");
...
if(isset($_POST['btnsend']))
{
	...
	if($email==$to_email)
	{
		...
		$abc=rand(1000,	9999);
		$body="hi $to_email your OTP is $abc sended by Style Barber saloon";
		$headers = 'From:shahtirth1010@gmail.com';
		if(mail($to_email,$subject,$body,$headers))
		{
			$send=mysqli_query($con,"insert into forgotemail values(null,'$to_email','$abc')");
			if($send)
			{
			...
			{
				echo '<script>alert("Not Stored In Database...")</script>';
			}
		}
		else
		{
...
if(isset($_POST['btnsendotp']))
{
	...
	$otp=$_POST['txtotp'];
	$to_email =$_POST['txtforgetemail'];
	$check_otp=mysqli_query($con,"select * from forgotemail where email='$to_email' and random=$otp'");
	$row=mysqli_fetch_array($check_otp);
	if($check)
	{
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="blue" id="id-company-text"><i>Style Barber</i></h4>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										...
										<div class="toolbar clearfix">
											<div>
												<a href="forget.php"  class="forgot-password-link">
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<form method="post" enctype="multipart/form-data">
												...
												<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="txtotp" class="form-control" placeholder="Enter OTP"  ></input>
															<i class="ace-icon fa fa-envelope"></i>
														</span>
													</label>
													<div class="clearfix">
														<input type="submit" name="btnsendotp" class="width-35 pull-right btn btn-sm btn-danger" value="Enter"></input>																											
