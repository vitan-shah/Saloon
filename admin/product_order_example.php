...
$q=mysqli_query($con,"select * from order_master where product_or_service='product' and status=0");
...
<?php
$con=mysqli_connect("localhost","root","","project");
$q=mysqli_query($con,"select * from order_master where product_or_service='product' and status=1");
$query=mysqli_query($con,"select * from address");
while($row=mysqli_fetch_array($q) and $rows=mysqli_fetch_array($query))
{
?>
