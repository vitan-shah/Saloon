...
if(isset($_POST['btnsend']))
{
	...
	if($email==$to_email)
	{
		...
		$succ=mail($to_email,$subject,$body,$headers);
		if($succ)
		{
			$send=mysqli_query($con,"insert into forgetemail values(null,'$to_email','$abc','0')");
			if($send)
			{
		...
		{
			echo '<script>alert("E-mail sending failed.. OR (Check Your Network Connection...)")</script>';
		}
	}
	else
	{
...
?>
	...
	{
		$otp=$_POST['txtotp'];
		$aaa=mysqli_query($con,"select * from forgetemail where status=0 and random='$otp' ");
		if($aaa)
		{
			header('location:newpassword.php');
			$aba=mysqli_query($con,"update forgetemail set status=1 where random=$otp ");
											...
											<form method="post" enctype="multipart/form-data">
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="txtforgetemail" class="form-control" placeholder="Email"  ></input>
															<i ></i>
														</span>
													</label>
